...
final class iTermLegacyStyleStringTest: XCTestCase {
    ...
    func testCloneAndMutableCloneIndependence() {
        ...
        guard let m = legacy.mutableClone() as? iTermMutableStringProtocolSwift else {
    ...
    func testExternalAttributesIndex_andExternalAttributeAt() {
        ...
        guard let idx = legacy.externalAttributesIndex() else {
            XCTFail("Expected legacy string to have external attributes index")
            return
        }
