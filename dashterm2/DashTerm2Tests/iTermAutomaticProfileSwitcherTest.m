...
- (Profile *)profileUserGeorgeHostItermPathHome {
    return @{ KEY_NAME: @"user=george host=example.com path=home",
              KEY_GUID: @"7",
              KEY_BOUND_HOSTS: @[ @"george@example.com:/home" ] };
}
...
- (Profile *)profileUserGeorgeHostIterm {
    return @{ KEY_NAME: @"user=george host=example.com",
              KEY_GUID: @"9",
              KEY_BOUND_HOSTS: @[ @"george@example.com" ] };
}

- (Profile *)profileHostItermPathHome {
    return @{ KEY_NAME: @"host=example.com path=home",
              KEY_GUID: @"10",
              KEY_BOUND_HOSTS: @[ @"example.com:/home" ] };
}

- (Profile *)profileHostIterm {
    return @{ KEY_NAME: @"host=example.com", KEY_GUID: @"11", KEY_BOUND_HOSTS: @[ @"example.com" ] };
}
...
- (void)testSwitchesOnHostName {
    ...
    [_aps setHostname:@"b" username:@"whatever" path:@"whatever" job:@"whatever" commandLine:nil];
...
- (void)testSwitchesOnUserName {
    ...
    [_aps setHostname:@"whatever" username:@"y" path:@"whatever" job:@"whatever" commandLine:nil];
...
- (void)testSwitchesOnPath {
    ...
    [_aps setHostname:@"whatever" username:@"whatever" path:@"/dir2" job:@"whatever" commandLine:nil];
...
- (void)testSwitchesOnWildcard {
    ...
    [_aps setHostname:@"example.com" username:@"george" path:@"/home" job:@"whatever" commandLine:nil];
...
- (void)testSwitchesOnJob {
    ...
    [_aps setHostname:@"whatever" username:@"whatever" path:@"whatever" job:@"y" commandLine:nil];
...
- (void)testMatchAll {
    ...
    [_aps setHostname:@"whatever" username:@"whatever" path:@"whatever" job:@"whatever" commandLine:nil];
...
- (void)testJobOutranksUsernamePath {
    ...
    [_aps setHostname:@"whatever" username:@"george" path:@"/home" job:@"x" commandLine:nil];
...
- (void)testPreferSpecificRuleEvenIfStackHasMatch {
    ...
    [_aps setHostname:@"example.com"
             username:@"george"
                 path:@"/"
                  job:@"job" commandLine:nil];
...
- (void)testWalkUpStack {
    ...
    [_aps setHostname:@"example.com"
             username:@"george"
                 path:@"bogus path"
                  job:@"job" commandLine:nil];
    // stack is now: example.com, george@example.com
    [_aps setHostname:@"example.com"
             username:@"george"
                 path:@"/home"
                  job:@"job" commandLine:nil];
    // stack is now: example.com, george@example.com, george@example.com:/home
    [_aps setHostname:@"example.com"
             username:@"george"
                 path:@"bogus path"
                  job:@"job" commandLine:nil];
    // If we didn't walk the stack all the way back up we should be on george@example.com
    XCTAssert([_profile isEqualToProfile:[self profileUserGeorgeHostIterm]]);
}
...
- (void)testDontChangeProfileIfSame {
    ...
    [_aps setHostname:@"example.com" username:@"george" path:@"/" job:@"job" commandLine:nil];
...
- (void)testSaveAndRestore {
    ...
    // Pop one level
    [aps2 setHostname:@"example.com" username:@"george" path:@"asdf" job:@"job" commandLine:nil];
    // stack is now: example.com, george@example.com
    XCTAssert([_profile isEqualToProfile:[self profileUserGeorgeHostIterm]]);
...
- (void)testUserNameWithAtSign {
    ...
    [_aps setHostname:@"hostname.com" username:@"user@example.com" path:@"/" job:@"whatever" commandLine:nil];
