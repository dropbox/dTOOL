...
@interface DashTerm2FakeObject : NSObject<iTermWeaklyReferenceable>
@property(nonatomic, assign) int number;
@end

@implementation DashTerm2FakeObject
ITERM_WEAKLY_REFERENCEABLE
@end
...
- (void)testProxyForwardsExistingMethods {
    DashTerm2FakeObject *fakeObject = [[[DashTerm2FakeObject alloc] init] autorelease];
    fakeObject.number = 1234;
    DashTerm2FakeObject *ref = [fakeObject weakSelf];
...
- (void)testProxyReturnsZeroForFreedObject {
    DashTerm2FakeObject *fakeObject = [[DashTerm2FakeObject alloc] init];
    fakeObject.number = 1234;
    DashTerm2FakeObject *ref = [fakeObject weakSelf];
    [fakeObject release];
...
- (void)testRaceConditions {
    dispatch_queue_t q1 = dispatch_queue_create("com.dashterm.dashterm2.WeakReferenceTest1", NULL);
    dispatch_queue_t q2 = dispatch_queue_create("com.dashterm.dashterm2.WeakReferenceTest2", NULL);
