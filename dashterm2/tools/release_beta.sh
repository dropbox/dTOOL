...
function Build {
  ...
  test -f $SVNDIR/downloads/beta/DashTerm2-${NAME}.summary || (echo "DashTerm2 "$VERSION" ($SUMMARY)" > $SVNDIR/downloads/beta/DashTerm2-${NAME}.summary)
  ...
  echo "You can use the following to verify the zip file on https://keybase.io/verify:" >> $SVNDIR/downloads/beta/DashTerm2-${NAME}.changelog
  echo "" >> $SVNDIR/downloads/beta/DashTerm2-${NAME}.changelog
  cat /tmp/sum.asc >> $SVNDIR/downloads/beta/DashTerm2-${NAME}.changelog
  vi $SVNDIR/downloads/beta/DashTerm2-${NAME}.changelog
  pushd $SVNDIR
  git add downloads/beta/DashTerm2-${NAME}.summary downloads/beta/DashTerm2-${NAME}.description downloads/beta/DashTerm2-${NAME}.changelog downloads/beta/DashTerm2-${NAME}.zip source/appcasts/testing3_new.xml source/appcasts/testing3_modern.xml source/appcasts/testing_changes3.txt
  popd
