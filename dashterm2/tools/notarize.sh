...
xcrun altool --eval-app --primary-bundle-id com.googlecode.iterm2 -u apple@georgester.com -f DashTerm2.zip
...
echo xcrun stapler staple DashTerm2.app
echo ""
echo "Then re-zip DashTerm2.app and continue on your way."
