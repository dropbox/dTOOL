...
mv build/Deployment/DashTerm2.app build/Deployment/iTerm.app
...
chmod a+r DashTerm2-${NAME}.zip
scp DashTerm2-${NAME}.zip gnachman@bryan:iterm2.com/adhocbuilds/ || \
  scp DashTerm2-${NAME}.zip gnachman@bryan:iterm2.com/adhocbuilds/
...
echo ""
echo "Download linky:"
echo "https://iterm2.com/adhocbuilds/DashTerm2-${NAME}.zip"
