...
# BUG-108: Version requirements updated to "Requires DashTerm2 version".
"""
...
class StatusBarComponent:
        ...
        if not iterm2.capabilities.supports_status_bar_unread_count(
            ...
            raise iterm2.capabilities.AppVersionTooOld(
                ("Unread count in status bar components is not " +
                 "supported in this version of DashTerm2. Please upgrade " +
                 "to use this script."))
    ...
    async def async_register(
        ...
        :param timeout: How long DashTerm2 should wait before giving up on this
