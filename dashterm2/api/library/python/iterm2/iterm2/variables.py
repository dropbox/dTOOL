"""
Provides support for DashTerm2 variables, which hold information associated
...
class VariableMonitor:
    ...
    `VariableMonitor` is a context manager that helps observe changes in DashTerm2
    Variables.
