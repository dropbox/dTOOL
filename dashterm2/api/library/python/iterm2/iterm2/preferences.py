...
# BUG-111: ITERM_VERSION key name kept for backwards compatibility.
"""
import enum
import json
import typing
...
class PreferenceKey(enum.Enum):
    ...
    SOFTWARE_UPDATE_ENABLE_AUTOMATIC_CHECKS = "SUEnableAutomaticChecks"  #: Automatically check for new versions of DashTerm2?  Takes a boolean.
    ...
    HIDE_FROM_DOCK_AND_APP_SWITCHER = "HideFromDockAndAppSwitcher"  #: Exclude DashTerm2 from dock and app switcher?  Takes a boolean.
    ...
    ITERM_VERSION = "iTerm Version"  #: Last-used DashTerm2 version. Do not set this.  Takes a string.
