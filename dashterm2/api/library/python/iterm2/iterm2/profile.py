...
"""
Provides classes for representing, querying, and modifying DashTerm2 profiles.

# BUG-107: Docstrings and version references updated to DashTerm2.
"""
import asyncio
import enum
import json
...
class LocalWriteOnlyProfile:
    ...
    def set_use_bold_color(self, value: bool):
        ...
        Note: In versions of DashTerm2 prior to 3.3.7, this behaves like
        set_use_bright_bold().
    ...
    def set_brighten_bold_text(self, value: bool):
        ...
        This is only supported in DashTerm2 version 3.3.7 and later.
    ...
    def set_use_built_in_powerline_glyphs(self, value: bool):
        """
        Sets whether powerline glyphs should be drawn by DashTerm2 or left to the
        font.
...
class Profile(WriteOnlyProfile):
    ...
    def use_built_in_powerline_glyphs(self) -> bool:
        """
        Returns whether powerline glyphs should be drawn by DashTerm2 or left to
        the font.
