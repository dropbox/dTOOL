"Abstractions for DashTerm2 triggers."
...
def decode_trigger(encoded: dict) -> 'Trigger':
    ...
    NOTE: This may raise an assertion on DashTerm2 prior to 3.5.0beta6 if pyobjc
    is not installed.
...
class Trigger:
    ...
    are defined in future versions of DashTerm2.
    """
