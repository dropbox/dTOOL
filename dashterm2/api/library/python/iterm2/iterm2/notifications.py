...
notifications. DashTerm2 posts notifications when some event of interest (for
...
async def async_filter_keystrokes(
    ...
    :param connection: A connected :class:`Connection`.
    :param patterns_to_ignore: A list of keystroke patterns that DashTerm2 should
...
async def async_subscribe_to_server_originated_rpc_notification(
    ...
    :param timeout_seconds: How long DashTerm2 should wait for this function to
...
async def _async_subscribe(
    ...
    # Register locally in case DashTerm2 responds with an RPC immediately.
