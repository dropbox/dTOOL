...
# BUG-109: Error messages updated to reference DashTerm2.
"""
...
class Arrangement:
    ...
    async def async_list(
        ...
        NOTE: This requires DashTerm2 version 3.4.0 or later.
        ...
        :throws: SavedArrangementException
        """
        # Throw if DashTerm2 is too old to support this feature.
