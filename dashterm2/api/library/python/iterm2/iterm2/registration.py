...
def RPC(func):  # pylint: disable=invalid-name
    ...
    An RPC is a function in a script that DashTerm2 can invoke in response to some
    ...
    return, DashTerm2 will stop waiting for the RPC after the timeout elapses.
