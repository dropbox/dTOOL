...
class PromptState(enum.Enum):
    ...
    UNKNOWN = -1  #: This version of DashTerm2 does not report prompt state (you should upgrade)
...
class Prompt:
    ...
    def unique_id(self) -> typing.Optional[str]:
        ...
        Will be None if not available because the version of DashTerm2 is too
        old to report it."""
...
async def async_get_last_prompt(
    ...
    :param connection: The connection to DashTerm2.
...
class PromptMonitor:
    ...
    version of DashTerm2 will result in an exception telling the user to upgrade.
    ...
    def __init__(
        ...
        if (modes != [PromptMonitor.Mode.PROMPT] and
            ...
            raise iterm2.capabilities.AppVersionTooOld(
                "This version of DashTerm2 is too old to handle the " +
    ...
    async def async_get(
        ...
        :returns: A tuple of (PROMPT,Optional[Prompt]), (COMMAND_START,Str), or
            ...
            Int gives the exit status of the command. Older versions of DashTerm2 will
