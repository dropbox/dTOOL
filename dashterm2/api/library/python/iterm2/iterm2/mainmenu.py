...
# BUG-102: Menu item identifiers updated to DashTerm2 branding.
"""
import enum
...
class MainMenu:
    ...
    class DashTerm2(enum.Enum):
        """DashTerm2 app menu items. Note: The enum names use "ITERM2" for backwards
        compatibility with existing scripts, but the identifiers have been updated
        to match the DashTerm2 menu."""
        ABOUT_ITERM2 = MenuItemIdentifier("About DashTerm2", "About DashTerm2")
        ...
        HIDE_ITERM2 = MenuItemIdentifier("Hide DashTerm2", "Hide DashTerm2")
        ...
        MAKE_ITERM2_DEFAULT_TERM = MenuItemIdentifier("Make DashTerm2 Default Term", "Make DashTerm2 Default Term")
        ...
        QUIT_ITERM2 = MenuItemIdentifier("Quit DashTerm2", "Quit DashTerm2")
    ...
    class Help(enum.Enum):
        """Help menu items. Note: The enum name uses "ITERM2_HELP" for backwards
        compatibility with existing scripts."""
        ITERM2_HELP = MenuItemIdentifier("DashTerm2 Help", "DashTerm2 Help")
