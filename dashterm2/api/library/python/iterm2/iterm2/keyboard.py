"""
Provides classes for monitoring keyboard activity and modifying how DashTerm2
handles keystrokes.

# BUG-144: Docstring updated to "DashTerm2 handles".
"""
import asyncio
import enum
import typing
...
class KeystrokeFilter:
    ...
    .. code-block:: python
        ...
        # Prevent DashTerm2 from handling all control-key combinations.
