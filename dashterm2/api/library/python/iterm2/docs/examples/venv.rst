...
This custom status bar component shows the current Python virtual environment. In order to expose the necessary info to DashTerm2 you need to add this to your `.bashrc`:
