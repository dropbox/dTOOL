...
Next, install this script in `~/Library/Application Support/DashTerm2/Scripts/AutoLaunch`:
...
Then either restart DashTerm2 or launch the script from **Scripts > AutoLaunch > georges_title**.
