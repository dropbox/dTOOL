...
* Using `patterns_to_ignore` to prevent DashTerm2 from handling certain keystrokes
...
.. code-block:: python
    ...
    async def main(connection):
        ...
        # This prevents DashTerm2 from handling them when the bottomLeft session has keyboard focus.
