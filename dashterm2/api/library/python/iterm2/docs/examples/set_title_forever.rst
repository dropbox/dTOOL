...
.. BUG-116: Example updated to "Launch DashTerm2".

Launch DashTerm2 and Set Session Title
======================================

This script demonstrates two concepts:

1. Launching DashTerm2 using PyObjC and running the script only
...
command line rather than from within DashTerm2. To run this
...
within DashTerm2 but your system Python configuration will not
