...
Status bar components should usually be placed in the `AutoLaunch` folder so they'll always be running. You'll need to manually launch it the first time, or else restart DashTerm2 to have it launched automatically.
...
.. code-block:: python
    ...
    # The name of the DashTerm2 variable to store the result
    VARIABLE = "weather"
