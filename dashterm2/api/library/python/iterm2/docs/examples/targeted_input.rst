...
DashTerm2 has a "broadcast input" feature that lets you send keyboard input to
...
.. code-block:: bash
    ...
    ~/Library/ApplicationSupport/DashTerm2/Scripts/TargetedInput/iterm2env/versions/*/bin/pip3 install aiohttp
