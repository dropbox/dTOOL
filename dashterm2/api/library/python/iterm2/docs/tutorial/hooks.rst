...
DashTerm2 provides a mechanism called *hooks* that allows your Python code to modify the app's default behavior.
...
.. note::
    ...
    These reference links currently use the historical iterm2.com URLs until
    DashTerm2 documentation hosting is available. Update them once the new site
    is live.
...
`~/Library/Application Support/DashTerm2/Scripts/AutoLaunch` folder.
