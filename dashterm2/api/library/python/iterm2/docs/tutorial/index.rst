...
The DashTerm2 Python API (imported as the ``iterm2`` module for compatibility)
is a replacement for the AppleScript API that preceded it. It offers a more
powerful set of APIs that give the script writer a great deal of control.
...
DashTerm2 provides a convenient user interface for creating a new script. Select
