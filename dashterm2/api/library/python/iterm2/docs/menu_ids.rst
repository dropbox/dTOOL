...
======================================================================================= ==============================================================================
DashTerm2 > About DashTerm2                                                             `About DashTerm2`
DashTerm2 > Show Tip of the Day                                                         `Show Tip of the Day`
DashTerm2 > Check for Updates…                                                          `Check For Updates…`
DashTerm2 > Toggle Debug Logging                                                        `Toggle Debug Logging`
DashTerm2 > Copy Performance Stats                                                      `Copy Performance Stats`
DashTerm2 > Capture GPU Frame                                                           `Capture Metal Frame`
DashTerm2 > Preferences...                                                              `Preferences...`
DashTerm2 > Hide DashTerm2                                                              `Hide DashTerm2`
DashTerm2 > Hide Others                                                                 `Hide Others`
DashTerm2 > Show All                                                                    `Show All`
DashTerm2 > Secure Keyboard Entry                                                       `Secure Keyboard Entry`
DashTerm2 > Make DashTerm2 Default Term                                                 `Make DashTerm2 Default Term`
DashTerm2 > Make Terminal Default Term                                                  `Make Terminal Default Term`
DashTerm2 > Install Shell Integration                                                   `Install Shell Integration`
DashTerm2 > Remove Recent Profiles from Dock Menu                                       `Remove Recent Profiles from Dock Menu`
DashTerm2 > Quit DashTerm2                                                              `Quit DashTerm2`                                                                 
...
Help > DashTerm2 Help                                                                   `DashTerm2 Help`                                                                 
