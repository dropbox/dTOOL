...
@property (nonatomic, strong, nullable) NSMutableArray<iTermMetalImageRun *> *imageRuns;
@property (nonatomic) BOOL belongsToBlock;
@property (nonatomic, strong, nullable) NSMutableArray<iTermKittyImageRun *> *kittyImageRuns;
