...
- (instancetype)initWithContext:(iTermVariablesSuggestionContext)context
    ...
    if (self) {
        _owner = owner;
        _context = context;
        _values = [NSMutableDictionary dictionaryWithCapacity:32];
        _resolvedLinks = [NSMutableDictionary dictionaryWithCapacity:8];
        _unresolvedLinks = [NSMutableDictionary dictionaryWithCapacity:8];
...
- (NSArray *)strongArrayFromWeakArray:(NSPointerArray *)weakArray {
    NSMutableArray *result = [NSMutableArray arrayWithCapacity:weakArray.count];
...
+ (NSSet<NSString *> *)namesToRecordFromSet:(NSSet<NSString *> *)names inContext:(iTermVariablesSuggestionContext)context {
    ...
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        seen = [NSMutableDictionary dictionaryWithCapacity:4];
        seen[@(iTermVariablesSuggestionContextSession)] = [NSMutableSet setWithCapacity:64];
        seen[@(iTermVariablesSuggestionContextTab)] = [NSMutableSet setWithCapacity:32];
        seen[@(iTermVariablesSuggestionContextWindow)] = [NSMutableSet setWithCapacity:32];
        seen[@(iTermVariablesSuggestionContextApp)] = [NSMutableSet setWithCapacity:16];
    });
...
- (NSDictionary<NSString *,NSString *> *)stringValuedDictionaryInScope:(nullable NSString *)scopeName {
    NSMutableDictionary<NSString *, NSString *> *result = [NSMutableDictionary dictionaryWithCapacity:_values.count];
...
- (NSDictionary<NSString *, id> *)dictionaryInScope:(nullable NSString *)scopeName {
    ...
    for (NSString *name in _values) {
        id value = _values[name];
        // BUG-f1105: Guard against self-referential values to prevent infinite recursion
        if (value == self) {
            ELog(@"iTermVariables dictionaryInScope: skipping self-referential value for %@", name);
            continue;
        }
