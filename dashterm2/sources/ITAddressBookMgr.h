...
// Fast startup methods - use these for <0.3s launch
// Creates singleton with minimal default profile (no disk I/O)
+ (void)initializeMinimalForStartup;
// Loads remaining profiles asynchronously after window is visible
