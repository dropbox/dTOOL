...
window.loadPermissions = function(offset = 0, limit = 50, searchQuery = '', permissionTypeFilter = '', statusFilter = '') {
    ...
    if (window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers['dashterm2-about:permissions']) {
        window.webkit.messageHandlers['dashterm2-about:permissions'].postMessage({
