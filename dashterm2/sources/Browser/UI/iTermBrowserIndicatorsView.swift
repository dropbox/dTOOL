...
class iTermBrowserIndicatorsView: NSView {
    ...
    private func layoutIndicators() {
        ...
        // BUG-1698: Use guard instead of force unwrap for sequentialIndicatorIdentifiers()
        guard let orderedIdentifiers = iTermIndicatorsHelper.sequentialIndicatorIdentifiers() else {
            return
        }
