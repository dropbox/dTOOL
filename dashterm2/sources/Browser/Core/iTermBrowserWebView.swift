...
class iTermBrowserWebView: iTermBaseWKWebView, iTermEditableTextDetecting {
    ...
    init(frame: CGRect,
        ...
        registerForDraggedTypes([
            ...
            NSPasteboard.PasteboardType("com.dashterm.dashterm2.psm.controlitem")
        ])    }

    required init?(coder: NSCoder) {
        // BUG-f846: Return nil instead of crashing for unused coder initializer
        DLog("iTermBrowserWebView init(coder:) is not supported")
        return nil
    }
    ...
    @objc override func printView(_ sender: Any?) {
        ...
        // BUG-1612: Use guard to safely unwrap window instead of force unwrap
