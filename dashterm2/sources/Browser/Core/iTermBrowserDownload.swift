...
extension iTermBrowserDownload: WKDownloadDelegate {
    func download(_ download: WKDownload, 
        ...
        // Use DashTerm2's downloads directory
        ...
        // BUG-1804: Use guard let instead of force unwrap for finalDestination
        // Generate final destination path
        guard let finalDestination = self.finalDestination(forPath: suggestedFilename,
