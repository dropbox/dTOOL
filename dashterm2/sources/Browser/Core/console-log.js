 (function() {
     ...
     let _postMessage = () => {};
     if (window.webkit?.messageHandlers?.DashTerm2ConsoleLog) {
         _postMessage = window.webkit.messageHandlers.DashTerm2ConsoleLog
             .postMessage
             .bind(window.webkit.messageHandlers.DashTerm2ConsoleLog);
     }
