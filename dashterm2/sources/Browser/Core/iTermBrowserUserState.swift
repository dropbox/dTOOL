...
extension iTermBrowserUserState {
    ...
    public func registerWebView(_ webView: iTermBrowserWebView, contentManager: BrowserExtensionUserContentManager, tabId: Int? = nil, frameId: Int? = nil) {
        Task { @MainActor in
            await extensionManager?.addWebView(webView, contentManager: contentManager, tabId: tabId, frameId: frameId)
        }
    }
