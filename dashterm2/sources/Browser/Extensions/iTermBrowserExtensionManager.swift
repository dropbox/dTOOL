...
protocol iTermBrowserExtensionManagerProtocol: AnyObject {
    func addWebView(_ webView: WKWebView, contentManager: BrowserExtensionUserContentManager, tabId: Int?, frameId: Int?) async
...
extension iTermBrowserExtensionManager: iTermBrowserExtensionManagerProtocol {
    ...
    func addWebView(_ webView: WKWebView, contentManager: BrowserExtensionUserContentManager, tabId: Int? = nil, frameId: Int? = nil) async {
        do {
