(function() {
    ...
    console.debug('[DashTerm2 Audio] monitor-audio-context.js loaded');
    ...
    class WrappedAC extends RealAC {
        constructor(...args) {
            console.debug('[DashTerm2 Audio] AudioContext created on', window.location.href);
            super(...args);
    ...
    class WrappedOAC extends RealOAC {
        constructor(...args) {
            console.debug('[DashTerm2 Audio] OfflineAudioContext created on', window.location.href);
            super(...args);
            window.webkit.messageHandlers.DashTerm2AudioHandler.postMessage({
