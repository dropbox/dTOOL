...
window.loadBookmarks = function(offset = 0, limit = 50, searchQuery = '', sortBy = 'dateAdded', tags = [], retryCount = 0) {
    ...
    if (window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers['dashterm2-about:bookmarks']) {
        window.webkit.messageHandlers['dashterm2-about:bookmarks'].postMessage({
