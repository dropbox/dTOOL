...
class AITermControllerRegistrationHelper {
    ...
    func requestRegistration(in window: NSWindow, completion: @escaping (AITermController.Registration?) -> ()) {
        ...
        // BUG-1606: Use guard to safely unwrap window instead of force unwrap
        guard let sheet = windowController.window else {
            completion(nil)
            return
        }
...
class AITermRegistrationWindowController: NSWindowController {
    ...
    override func awakeFromNib() {
        ...
        case .gemini:
            ["https://aistudio.google.com/prompts/new_chat",
             ...
             "https://dashterm.com/aiterm",
             "Gemini"]
        // BUG-2900: Don't crash on unknown vendor - use generic help URLs
        @unknown default:
            ["https://dashterm.com/aiterm",
             "https://dashterm.com/aiterm",
             "https://dashterm.com/aiterm",
    ...
    @IBAction func ok(_ sender: Any) {
        ...
        // BUG-1606: Use if-let to safely unwrap window instead of force unwrap
