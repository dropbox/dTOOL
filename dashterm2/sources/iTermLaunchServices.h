...
// Returns the GUID that is assigned to the scheme, even if DashTerm2 isn't registered for the scheme.
- (NSString *)guidForScheme:(NSString *)scheme;

// Returns the profile that is assigned to the scheme, returning nil if DashTerm2 isn't registered for
// the scheme.
