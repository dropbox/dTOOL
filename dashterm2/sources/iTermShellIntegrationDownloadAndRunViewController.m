...
// BUG-1: Shell integration URLs updated to dashterm.com
- (NSString *)urlString {
    if (self.installUtilities) {
        return @"https://dashterm.com/shell_integration/install_shell_integration_and_utilities.sh";
    }
    return @"https://dashterm.com/shell_integration/install_shell_integration.sh";
}
