...
// Returns the highlight bitmap for an absolute line, or nil if the line has no matches.
- (nullable NSData *)highlightDataForAbsoluteLine:(long long)absoluteLine;

// Returns YES when any highlight bitmap is currently stored.
