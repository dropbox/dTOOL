...
+ (instancetype)backgroundRunsInLine:(const screen_char_t *)theLine
    ...
    // Typical line has 1-10 background color runs; pre-allocate to avoid reallocation
    NSMutableArray *runs = [NSMutableArray arrayWithCapacity:8];
...
+ (instancetype)defaultRunOfLength:(int)width
    ...
    // Default run is just one entry
    NSMutableArray *runs = [NSMutableArray arrayWithCapacity:1];
