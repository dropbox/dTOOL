...
struct Message: Codable {
    ...
    mutating func append(_ attachment: LLM.Message.Attachment, vectorStoreID: String?) {
        ...
        case .multipart(var subparts, let vectorStoreID):
            ...
            // BUG-f511: DESIGN_LIMITATION: Attachments are not supported for these message types.
            ...
            // Instead of crashing, log and ignore the attachment.
        case .explanationRequest, .explanationResponse, .remoteCommandRequest,
                ...
                .vectorStoreCreated, .userCommand:
            DLog("Warning: Cannot add attachment to message with content type that doesn't support attachments")
        }
    }
    ...
    mutating func append(_ chunk: String, useMarkdownIfAmbiguous: Bool) {
        ...
        // BUG-f512: Instead of crashing, log and ignore append for unsupported content types
        case .explanationRequest, .explanationResponse, .remoteCommandRequest,
                ...
                .userCommand:
            DLog("Warning: Cannot append text to message with content type that doesn't support appending")
        }
    }
