...
/// For VT100_UNKNOWNCHAR, VT100CSI_SCS0...SCS3, and VT100_LITERAL.
/// This provides Swift access to the @public code ivar.
@property(nonatomic) unsigned char codeValue;
@property(nonatomic, strong) NSArray<VT100Token *> *subtokens;

#pragma mark - Pooling Support

/// Indicates whether this token is managed by VT100TokenPool.
/// When YES, the token should be recycled via the pool instead of autoreleased.
@property(nonatomic) BOOL pooled;

/// Resets all fields to initial state for pool reuse.
/// Called automatically by VT100TokenPool when recycling a token.
