...
extension NSEvent {
    ...
    static func it_isControlCodeWithOption(
        ...
        // BUG-1680: Use constant for ASCII value of '@' instead of force unwrap
        let atCharValue: UInt8 = 64  // ASCII value of '@'
        let controlCode = Character(UnicodeScalar(character + atCharValue))
