...
extension NSView {
    ...
    func setVisibility(forTerminalEnclosures terminal: Bool,
        ...
        tabViewItemView.walk { either in
            ...
            case .left(let subview):
                // BUG-1685: Use already-bound enclosure instead of force cast (inherits from ModalEnclosure)
    ...
    private func updateViews(remove: [[ModalEnclosure]],
        ...
        for modalEnclosuresToRemove in remove {
            guard let firstEnclosure = modalEnclosuresToRemove.first,
                  let parent = firstEnclosure.superview else {
                continue
            }
