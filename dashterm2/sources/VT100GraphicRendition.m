    ...
    switch (code) {
        ...
        case VT100CHARATTR_UNDERLINE_COLOR: {
            ...
            if (j == i) {
                ...
                // BUG-3010: Handle unexpected color parse skip count gracefully (return safe value)
                return VT100GraphicRenditionSideEffectNone;
            }
        }
        case VT100CHARATTR_FG_256: {
            ...
            if (j == i) {
                ...
                // BUG-3011: Handle unexpected color parse skip count gracefully (return safe value)
                return VT100GraphicRenditionSideEffectNone;
            }
        ...
        case VT100CHARATTR_BG_256: {
            ...
            if (j == i) {
                ...
                // BUG-3012: Handle unexpected color parse skip count gracefully (return safe value)
                return VT100GraphicRenditionSideEffectNone;
            }
        }
        default:
...
//
// Lots of terminal emulators, DashTerm2 included, misunderstood the spec. That's
