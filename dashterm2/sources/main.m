...
int main(int argc, const char *argv[]) {
    ...
    // Note: Placeholder window is now shown in applicationWillFinishLaunching: to avoid
    // creating NSApplication before NSApplicationMain, which would cause iTermApplication
    // to not be used (leading to crashes and missing features). See BUG-f899.
