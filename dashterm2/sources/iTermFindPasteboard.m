...
@implementation iTermFindPasteboard {
    ...
    // BUG-1182: Cache system pasteboard value to avoid redundant reads
    NSString *_cachedSystemValue;
...
- (NSString *)stringValue {
    ...
    // BUG-1182: Use changeCount to avoid redundant pasteboard reads.
    // The pasteboard changeCount increments whenever the content changes.
    NSInteger currentChangeCount = [findBoard changeCount];
    if (_cachedSystemValue && currentChangeCount == _cachedChangeCount) {
        return _cachedSystemValue;
    }
