...
// DTermCore integration for GPU rendering
@optional
// Returns the DTermCoreIntegration for this session, if available and enabled.
// Used by DTermMetalView to get terminal state for rendering.
- (id)sessionViewDTermCoreIntegration;

// Returns the font used for rendering, used by DTermMetalView for glyph atlas.
...
// Show/hide the AI lock indicator in the title bar
