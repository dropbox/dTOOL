...
static NSMutableDictionary<NSString *, NSMutableArray<iTermUserDefaultsBlock> *> *
iTermUserDefaultsObserverBlocks(void) {
    static NSMutableDictionary<NSString *, NSMutableArray<iTermUserDefaultsBlock> *> *blocks;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        blocks = [NSMutableDictionary dictionaryWithCapacity:16]; // User defaults observer blocks
    });
    return blocks;
}

- (void)it_addObserverForKey:(NSString *)key block:(void (^)(id newValue))block {
