...
// dterm-core integration for parallel processing and comparison testing.
// This is a Swift class exposed to Objective-C via @objc.
@property(nonatomic, strong) DTermCoreIntegration *dtermCoreIntegration;
...
// Returns a dictionary describing scrollback memory packing statistics, or nil if unavailable.
// Keys: totalBlocks, packedBlocks, currentBytes, estimatedBytesSaved, totalRawLines, packedRawLines
- (NSDictionary<NSString *, NSNumber *> * _Nullable)scrollbackPackingStats;

// Command exit notification helpers.
