...
@property(nonatomic, weak) id<iTermSelectionDelegate> delegate;
...
// Returns the indexes of characters selected on a given line or nil if none are selected.
...
// display purposes. Removes selected TAB_FILLERS that aren't followed by a selected TAB. Returns nil
// when no characters are selected on the line.
