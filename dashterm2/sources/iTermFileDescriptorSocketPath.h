...
#ifndef __DashTerm2__iTermFileDescriptorSocketPath__
#define __DashTerm2__iTermFileDescriptorSocketPath__
...
#endif /* defined(__DashTerm2__iTermFileDescriptorSocketPath__) */
