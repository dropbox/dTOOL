...
- (NSArray<NSString *> *)stringVariants {
    ...
    NSMutableArray<NSString *> *variants = [[NSMutableArray alloc] initWithCapacity:parts.count];
...
+ (NSDictionary *)tmux_configurationWithInterpolatedStringExpression:(NSString *)expression {
    ...
    return @{
        iTermStatusBarComponentConfigurationKeyKnobValues :
            @{iTermStatusBarSwiftyStringComponentExpressionKey : interpolatedString}
    };
}
...
+ (instancetype)tmuxLayoutWithController:(TmuxController *)controller
    ...
    rightConfiguration =
        [self tmux_configurationWithInterpolatedStringExpression:iTermVariableKeySessionTmuxStatusRight];

    id<iTermStatusBarComponent> leftComponent =
        [[iTermStatusBarTmuxLeftComponent alloc] initWithConfiguration:leftConfiguration scope:scope];
    id<iTermStatusBarComponent> rightComponent =
        [[iTermStatusBarTmuxRightComponent alloc] initWithConfiguration:rightConfiguration scope:scope];
    ...
    iTermStatusBarLayout *layout = [[iTermStatusBarLayout alloc] initWithDictionary:layoutDict scope:scope];
