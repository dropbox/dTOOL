...
//  tests aren't compatible with XCTest (they fail to get the path to the DashTerm2ForAppleScript
//  app).
...
NSArray *TestClassesToRun(NSArray *include, NSArray *exclude) {
    ...
    NSMutableArray *testClassesToRun = [[NSMutableArray alloc] initWithCapacity:allTestClasses.count];
