...
extension NSMutableAttributedString {
    ...
    private func firstAnchorInfo() -> AnchorInfo? {
        ...
        // BUG-1615: Use guard to safely convert Range instead of force unwrap
        guard let swiftRange = Range(match.range) else { return nil }
        return AnchorInfo(range: swiftRange,
