...
- (NSString *)description {
    return [NSString stringWithFormat:@"Highlight Line with %@ over %@",
...
- (BOOL)performActionWithCapturedStrings:(NSArray<NSString *> *)stringArray
    ...
    const VT100GridAbsCoord absCoord = VT100GridAbsCoordMake(rangeInScreenChars.location, lineNumber);
    [aSession triggerSession:self highlightLineAt:absCoord colors:[self colorsPreservingColorSpace:NO]];
    return YES;
}
