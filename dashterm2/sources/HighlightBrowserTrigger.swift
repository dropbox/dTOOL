...
class HighlightBrowserTrigger: Trigger, iTermColorSettable {
    ...
    override func paramAttributedString() -> NSAttributedString {
        ...
        // BUG-1734: Use as? with fallback to NSMutableAttributedString initializer
        let mutableTextAttachmentString = (textAttachmentString.mutableCopy() as? NSMutableAttributedString) ?? NSMutableAttributedString(attributedString: textAttachmentString)
        ...
        // BUG-1735: Use as? with fallback to NSMutableAttributedString initializer
        let mutableBackgroundAttachmentString = (backgroundAttachmentString.mutableCopy() as? NSMutableAttributedString) ?? NSMutableAttributedString(attributedString: backgroundAttachmentString)
        // Lower the image by adjusting the baseline offset.
