...
- (void)statusBarComponentSizeView:(NSView *)view toFitWidth:(CGFloat)width {
    // BUG-f1274: Replace assert() with guard - unexpected view should log warning, not crash
    if (view != _viewController.view) {
        DLog(@"WARNING: BUG-f1274 statusBarComponentSizeView called with unexpected view %@ != %@", view, _viewController.view);
        return;
    }
