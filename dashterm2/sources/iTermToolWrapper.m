...
// BUG-1038: Ensure KVO bindings are cleaned up on deallocation
// BUG-3124: Cancel delayed setTitleEditable selector to prevent crash
- (void)dealloc {
...
- (void)setName:(NSString *)theName {
    // BUG-1037: Use proper KVO notifications so bound _title updates
