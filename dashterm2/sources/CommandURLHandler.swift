...
fileprivate class CommandOptionsView: NSView {
    ...
    init(
        ...
        // BUG-1768: Use nil coalescing with fallback instead of force unwrap
    ...
    required init?(coder: NSCoder) {
        // BUG-f830: Return nil instead of crashing for unused coder initializer
        DLog("CommandURLHandlerPanel init(coder:) is not supported")
        return nil
    }
