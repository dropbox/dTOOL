...
- (instancetype)initWithFunctionSignatures:(NSDictionary<NSString *,NSArray<NSString *> *> *)functionSignatures
    ...
    if (self) {
        ...
        // BUG-f1065: Replace assert with guard - parser creation failure should return nil not crash
        if (!_parser) {
            DLog(@"BUG-f1065: Failed to create CPLALR1Parser for function call suggester");
            return nil;
        }
