...
- (instancetype)initWithFrame:(NSRect)frameRect {
    ...
    if (self) {
        ...
        _actionButtons = [[NSMutableArray alloc] initWithCapacity:4];  // Announcement action buttons
...
- (NSString *)stringByAddingShortcutInString:(NSString *)original {
    ...
    // Guard against underscore at end of string
    if ((NSUInteger)(index + 1) >= original.length) {
        return original;
    }
