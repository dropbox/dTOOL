...
- (instancetype)initWithQueue:(dispatch_queue_t)queue
    ...
    if (self) {
        ...
        _queue = queue;
        _children = [NSMutableArray arrayWithCapacity:8];  // Typical child process count
    }
    return self;
}
...
- (BOOL)setProcessInfo:(iTermProcessInfo *)processInfo depth:(NSInteger)depth {
    ...
    NSMutableArray<iTermProcessMonitor *> *childrenToAdd = [NSMutableArray arrayWithCapacity:processInfo.children.count];
