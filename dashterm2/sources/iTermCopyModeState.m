...
- (BOOL)moveBackwardWord {
    return [self moveInDirection:kPTYTextViewSelectionExtensionDirectionLeft
                            unit:kPTYTextViewSelectionExtensionUnitWord];
}

- (BOOL)moveForwardWord {
    return [self moveInDirection:kPTYTextViewSelectionExtensionDirectionRight
                            unit:kPTYTextViewSelectionExtensionUnitWord];
}

- (BOOL)moveBackwardBigWord {
    return [self moveInDirection:kPTYTextViewSelectionExtensionDirectionLeft
                            unit:kPTYTextViewSelectionExtensionUnitBigWord];
}
...
- (BOOL)moveUp {
    return [self moveInDirection:kPTYTextViewSelectionExtensionDirectionUp
                            unit:kPTYTextViewSelectionExtensionUnitCharacter];
}

- (BOOL)moveDown {
    return [self moveInDirection:kPTYTextViewSelectionExtensionDirectionDown
                            unit:kPTYTextViewSelectionExtensionUnitCharacter];
}
...
- (BOOL)moveToStartOfLine {
    return [self moveInDirection:kPTYTextViewSelectionExtensionDirectionStartOfLine
                            unit:kPTYTextViewSelectionExtensionUnitCharacter];
}

- (BOOL)moveToEndOfLine {
    return [self moveInDirection:kPTYTextViewSelectionExtensionDirectionEndOfLine
                            unit:kPTYTextViewSelectionExtensionUnitCharacter];
}
...
- (BOOL)moveToStart {
    return [self moveInDirection:kPTYTextViewSelectionExtensionDirectionTop
                            unit:kPTYTextViewSelectionExtensionUnitCharacter];
}

- (BOOL)moveToEnd {
    return [self moveInDirection:kPTYTextViewSelectionExtensionDirectionBottom
                            unit:kPTYTextViewSelectionExtensionUnitCharacter];
}

- (BOOL)moveToStartOfIndentation {
    return [self moveInDirection:kPTYTextViewSelectionExtensionDirectionStartOfIndentation
                            unit:kPTYTextViewSelectionExtensionUnitCharacter];
}
...
- (BOOL)scroll:(PTYTextViewSelectionExtensionDirection)direction {
    ...
    switch (direction) {
        ...
        case kPTYTextViewSelectionExtensionDirectionStartOfIndentation:
            // BUG-13006: Replace assert(NO) with DLog for unexpected direction values
            // These directions are not supposed to be used with page up/down but handle gracefully
            DLog(@"Unexpected selection extension direction %d in scroll method", (int)direction);
            break;
    }
    return NO;
}

- (BOOL)moveInDirection:(PTYTextViewSelectionExtensionDirection)direction unit:(PTYTextViewSelectionExtensionUnit)unit {
    ...
    const VT100GridAbsWindowedRange absWindowedRange =
        VT100GridAbsWindowedRangeFromWindowedRange(windowedRange, overflow);
