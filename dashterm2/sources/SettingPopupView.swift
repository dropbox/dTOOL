...
extension SearchableComboViewGroup {
    ...
    private static func groupsFromSettings(_ settings: [iTermSetting],
        ...
        // BUG-1636: Use compactMap instead of force unwrap for dictionary access
        return groupsDict.keys.compactMap { pathComponents -> SearchableComboViewGroup? in
            guard let settings = groupsDict[pathComponents] else { return nil }
