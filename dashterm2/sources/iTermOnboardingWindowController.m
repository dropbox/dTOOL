...
//
// BUG-31: Onboarding window updated to DashTerm2 branding
...
static void iTermOpenWhatsNewURL(NSString *path, NSWindow *window) {
    NSURL *url = [NSURL URLWithString:@"dashterm2-about:onboarding-intro"];
...
- (void)openURL:(id)urlOrString {
    ...
    if ([url.scheme isEqualToString:@"dashterm2whatsnew"]) {
