...
+ (NSDictionary *)allTips {
  ...
  // BUG-1: Documentation URLs updated to dashterm.com
  // BUG-6: Tip of the Day content updated to DashTerm2 branding
  return @{
    // Big new features
            @"000": @{ kTipTitleKey: @"Tip of the Day",
                        kTipBodyKey: @"This window shows the DashTerm2 tip of the day. It’ll appear every 24 hours to let you know about new features and hidden secrets. Hit “More Options” to view more tips or to stop getting them altogether." },
            @"0000": @{ kTipTitleKey: @"Shell Integration",
                         kTipBodyKey: @"The big new feature of DashTerm2 version 3 is Shell Integration. Click “Learn More” for all the details.",
                          kTipUrlKey: @"https://dashterm.com/shell_integration.html" },
            ...
            @"0002": @{ kTipTitleKey: @"Password Manager",
                        kTipBodyKey: @"Did you know DashTerm2 has a password manager? Open it with “Window > Password Manager.” You can define a Trigger to open it for you at a password prompt in “Settings > Profiles > Advanced > Triggers.”" },
            ...
            @"0007": @{ kTipTitleKey: @"Inline Images",
                        kTipBodyKey: @"DashTerm2 can display images (even animated GIFs) inline.",
                        kTipUrlKey: @"https://dashterm.com/images.html" },
            ...
            @"0010": @{ kTipTitleKey: @"Badges",
                        ...
                        kTipUrlKey: @"https://dashterm.com/badges.html" },
            ...
            @"0011" : @{ kTipTitleKey: @"Dynamic Profiles",
                         ...
                         kTipUrlKey: @"https://dashterm.com/dynamic-profiles.html" },
    ...
    // Big but not new features
            ...
            @"0015": @{ kTipTitleKey: @"Tmux Integration",
                        kTipBodyKey: @"If you use tmux, try running “tmux -CC” to get DashTerm2’s tmux integration mode. The tmux windows show up as native DashTerm2 windows, and you can use DashTerm2’s keyboard shortcuts. It even works over ssh!",
                        kTipUrlKey: @"https://gitlab.com/gnachman/iterm2/wikis/TmuxIntegration" },

            @"0016": @{ kTipTitleKey: @"Triggers",
                        kTipBodyKey: @"DashTerm2 can automatically perform actions you define when text matching a regular expression is received. For example, you can highlight text or show an alert box. Set it up in “Settings > Profiles > Advanced > Triggers.”",
                        kTipUrlKey: @"https://dashterm.com/documentation-triggers.html" },
            ...
            @"0017": @{ kTipTitleKey: @"Smart Selection",
                        ...
                        kTipUrlKey: @"https://dashterm.com/smartselection.html" },
    ...
    // Small things
            ...
            @"0036": @{ kTipTitleKey: @"Downloads",
                        kTipBodyKey: @"DashTerm2 can download files by base-64 encoding them. Click “Learn More” to download a shell script that makes it easy.",
                        kTipUrlKey: @"https://dashterm.com/download.sh" },
            ...
            @"0038": @{ kTipTitleKey: @"Recent Directories",
                        kTipBodyKey: @"DashTerm2 remembers which directories you use the most on each host that has Shell Integration installed. There’s a Toolbelt tool to browse them, and ⌥⌘/ gives you a popup sorted by frequency and recency of use.",
                        kTipUrlKey: @"https://dashterm.com/shell_integration.html" },
            ...
            @"0040": @{ kTipTitleKey: @"Shell Integration History",
                        kTipBodyKey: @"Install Shell Integration and turn on “Settings > General > Save copy/paste and command history to disk” to remember command history per host across restarts of DashTerm2.",
                        kTipUrlKey: @"https://dashterm.com/shell_integration.html" },
            ...
            @"0061" : @{ kTipTitleKey: @"Bell Silencing",
                         kTipBodyKey: @"Did you know? If the bell rings too often, you’ll be asked if you’d like to silence it temporarily. DashTerm2 cares about your comfort." },
            ...
            @"0062" : @{ kTipTitleKey: @"Profile Search",
                         ...
                         kTipUrlKey: @"https://dashterm.com/search_syntax.html" },
            ...
            @"0063": @{ kTipTitleKey: @"Color Schemes",
                        ...
                        kTipUrlKey: @"https://dashterm.com/colorgallery"},
            ...
            @"0065": @{ kTipTitleKey: @"Coprocesses",
                        kTipBodyKey: @"A coprocess is a job, such as a shell script, that has a special relationship with a particular DashTerm2 session. All output in a terminal window (that is, what you see on the screen) is also input to the coprocess. All output from the coprocess acts like text that the user is typing at the keyboard.",
                        kTipUrlKey: @"https://dashterm.com/coprocesses.html" },
            ...
            @"0072": @{ kTipTitleKey: @"Python API",
                        kTipBodyKey: @"You can add custom behavior to DashTerm2 using the Python API.",
                        kTipUrlKey: @"https://dashterm.com/python-api" },

            @"0073": @{ kTipTitleKey: @"Status Bar",
                        kTipBodyKey: @"You can add a configurable status bar to your terminal windows.",
                        kTipUrlKey: @"https://dashterm.com/documentation-status-bar.html" },
            ...
            @"0092": @{ kTipTitleKey: @"Export/Import Settings",
                        kTipBodyKey: @"Easily backup or transfer your DashTerm2 settings using the Export/Import feature in “Settings > General > Settings”." },
            ...
            @"0117": @{ kTipTitleKey: @"AI Chat",
                        kTipBodyKey: @"DashTerm2 now has an AI Chat feature! Use “Window > AI Chats” or “Edit > Explain Output with AI”. The assistant can interact with your terminal (with your permission) and explain command output, adding annotations right in the terminal." },
            ...
            @"0118": @{ kTipTitleKey: @"Web Browser Profiles",
                        ...
                        kTipUrlKey: @"https://dashterm.com/documentation-web.html" },
