 ...
 * of messages sent over WebSocket from client to DashTerm2.
 **/
 ...
 * of messages sent over WebSocket from DashTerm2 to client.
 **/
...
/**
 * This is the result of an DashTerm2-to-script RPC call.
 **/
...
/**
 * The first time a tool is registered DashTerm2 automatically adds it to the
...
/**
 * Describes an RPC from DashTerm2 to script. I don't want to invent my own type
...
/** If not specified, DashTerm2 decides based on its built-in default. */
...
/**
 * This is an DashTerm2-to-script RPC call. The script must have registered for
