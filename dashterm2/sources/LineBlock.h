...
// in a buffer.
@interface LineBlock : NSObject <iTermUniquelyIdentifiable, iTermLineBlockReading>
...
@interface LineBlock (Packing)

/// Create a packed copy of this LineBlock for memory-efficient storage.
/// @param colorTable Shared color table for 24-bit colors (may be nil to create new).
/// @return A new LineBlockPacked, or nil if packing failed.
