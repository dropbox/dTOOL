...
func DLog(_ messageBlock: @autoclosure () -> String, file: String = #file, line: Int = #line, function: String = #function) {
    ...
    guard let fileCString = file.cString(using: .utf8),
          let functionCString = function.cString(using: .utf8) else {
        return
    }
    DebugLogImpl(fileCString, Int32(line), functionCString, message)
}
...
class iTermLogger {
    ...
    private static let logger = Logger(subsystem: "com.dashterm2.logger", category: "main")
...
extension DataProtocol {
    public var hexified: String { map { .init(format: "%02x", $0) }.joined() }
}

extension Data {
    public var stringOrHex: String {
