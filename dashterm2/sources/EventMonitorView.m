...
// BUG-396: Cancel delayed selector in dealloc to prevent crash if view is
// deallocated while a setStringValue: update is pending on label_.
- (void)dealloc {
    [NSObject cancelPreviousPerformRequestsWithTarget:label_];
...
- (void)rightMouseUp:(NSEvent *)theEvent {
    ...
    // BUG-4129: Call correct super method for event type
