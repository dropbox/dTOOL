...
fileprivate class UnsavedUserDefaultsViewController: NSViewController {
    ...
    required init?(coder: NSCoder) {
        // BUG-f824: Return nil instead of crashing for unused coder initializer
        DLog("UserDefaultsUnsavedController init(coder:) is not supported")
        return nil
    }
...
class UserDefaultsUnsavedController: NSTitlebarAccessoryViewController {
    ...
    // BUG-f585: Return nil instead of crashing for unused coder initializer
    required init?(coder: NSCoder) {
        DLog("UserDefaultsUnsavedController init(coder:) is not supported")
        return nil
    }
