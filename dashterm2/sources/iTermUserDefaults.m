...
static NSUserDefaults *iTermPrivateUserDefaults(void) {
    ...
    dispatch_once(&onceToken, ^{
        privateUserDefaults = [[NSUserDefaults alloc] initWithSuiteName:@"com.dashterm.dashterm2.private"];
    });
...
+ (iTermAppleWindowTabbingMode)appleWindowTabbingMode {
    ...
    dispatch_once(&onceToken, ^{
        ...
        globalDomain = [[NSUserDefaults alloc] initWithSuiteName:@"com.dashterm.dashterm2.fake"];
    });
