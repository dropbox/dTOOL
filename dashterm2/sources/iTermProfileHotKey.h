...
// iTerm after the hotkey window is dismissed (which would normally happen if DashTerm2 was not the
// active app when the hotkey window was shown). The hide-unhide cycles moves all the DashTerm2 windows
// behind the next app.
