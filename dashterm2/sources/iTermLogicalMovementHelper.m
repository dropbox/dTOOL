...
- (VT100GridAbsWindowedRange)absRangeByMovingStartOfRangeBack:(VT100GridAbsWindowedRange)existingRange
    ...
    // BUG-412: Return existing range instead of crashing for unexpected unit type
    // This handles any new selection extension units that may be added in the future
    DLog(@"iTermLogicalMovementHelper: Unexpected unit %d in absRangeByMovingStartOfRangeBackward, returning existing range", (int)unit);
...
- (VT100GridAbsWindowedRange)absRangeByMovingStartOfRangeForward:(VT100GridAbsWindowedRange)existingRange
    ...
    // BUG-413: Return existing range instead of crashing for unexpected unit type
    DLog(@"iTermLogicalMovementHelper: Unexpected unit %d in absRangeByMovingStartOfRangeForward, returning existing range", (int)unit);
    return existingRange;
}
...
- (VT100GridAbsWindowedRange)absRangeByMovingEndOfRangeBack:(VT100GridAbsWindowedRange)existingRange
    ...
    // BUG-414: Return existing range instead of crashing for unexpected unit type
    DLog(@"iTermLogicalMovementHelper: Unexpected unit %d in absRangeByMovingEndOfRangeBack, returning existing range", (int)unit);
    return existingRange;
}
...
- (VT100GridAbsWindowedRange)absRangeByMovingEndOfRangeForward:(VT100GridAbsWindowedRange)existingRange
    ...
    // BUG-415: Return existing range instead of crashing for unexpected unit type
    DLog(@"iTermLogicalMovementHelper: Unexpected unit %d in absRangeByMovingEndOfRangeForward, returning existing range", (int)unit);
    return existingRange;
}
...
- (VT100GridAbsWindowedRange)absRangeByExtendingRange:(VT100GridAbsWindowedRange)existingRange
    ...
    switch (endpoint) {
        case kPTYTextViewSelectionEndpointStart:
            ...
            // BUG-416: Return existing range for unexpected direction instead of crashing
            DLog(@"iTermLogicalMovementHelper: Unexpected direction %d for start endpoint, returning existing range", (int)direction);
            break;
        ...
        case kPTYTextViewSelectionEndpointEnd:
            ...
            // BUG-417: Return existing range for unexpected direction instead of crashing
            DLog(@"iTermLogicalMovementHelper: Unexpected direction %d for end endpoint, returning existing range", (int)direction);
            break;
    }
    // BUG-418: Return existing range for unexpected endpoint instead of crashing
    DLog(@"iTermLogicalMovementHelper: Unexpected endpoint %d in absRangeByExtendingRange, returning existing range", (int)endpoint);
    return existingRange;
}
