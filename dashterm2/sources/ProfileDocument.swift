...
class ProfileDocument: NSObject {
    private static let queue = DispatchQueue(label: "com.dashterm.dashterm2.recents")
    ...
    static func open(filename: String) {
        do {
            ...
            // BUG-1694: Use guard instead of force unwrap for iTermController.sharedInstance()
