...
class CommandExplainer: NSObject {
    ...
    // BUG-1678: Return optional URL to avoid force unwrap crash
    ...
    func explain(_ url: URL) {
        ...
        guard components.scheme == "dashterm2" else {
            return
        }
    ...
    private var browserName: String? {
        ...
        guard let url = URL(string: "https://explainshell.com/explain?cmd=example") else {
            return nil
        }
