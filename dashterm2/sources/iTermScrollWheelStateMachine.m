...
- (NSString *)description {
    return [NSString
        stringWithFormat:@"<%@: %p state=%@>", NSStringFromClass(self.class), self, [self stateString:self.state]];
}
...
static NSString *iTermStringForEventPhase(NSEventPhase eventPhase) {
    NSMutableArray<NSString *> *phase = [NSMutableArray arrayWithCapacity:3]; // Event phase flags
...
NSString *iTermShortEventPhasesString(NSEvent *event) {
    return [NSString stringWithFormat:@"<NSEvent: %p phase=%@, momentumPhase=%@, scrollingDeltaX=%f>", event,
...
- (void)handleEvent:(NSEvent *)event {
    ...
    } transitions[] = {{iTermScrollWheelStateMachineStateGround, NSEventPhaseBegan, NSEventPhaseNone,
                        iTermScrollWheelStateMachineStateStartDrag},
                       {iTermScrollWheelStateMachineStateGround, NSEventPhaseMayBegin, NSEventPhaseNone,
                        iTermScrollWheelStateMachineStateTouchAndHold},
                       {iTermScrollWheelStateMachineStateGround, NSEventPhaseNone, NSEventPhaseChanged,
                        iTermScrollWheelStateMachineStateGround},
                       // I'm not sure what this is or why it only happens sometimes. TODO
                       {iTermScrollWheelStateMachineStateGround, NSEventPhaseNone, NSEventPhaseBegan,
                        iTermScrollWheelStateMachineStateGround},
                       {iTermScrollWheelStateMachineStateGround, NSEventPhaseNone, NSEventPhaseEnded,
                        iTermScrollWheelStateMachineStateGround},
                       {iTermScrollWheelStateMachineStateGround, NSEventPhaseChanged, NSEventPhaseNone,
                        iTermScrollWheelStateMachineStateGround},
                       {iTermScrollWheelStateMachineStateGround, NSEventPhaseEnded, NSEventPhaseNone,
                        iTermScrollWheelStateMachineStateGround},


                       {iTermScrollWheelStateMachineStateStartDrag, NSEventPhaseChanged, NSEventPhaseNone,
                        iTermScrollWheelStateMachineStateDrag},
                       {iTermScrollWheelStateMachineStateStartDrag, NSEventPhaseEnded, NSEventPhaseNone,
                        iTermScrollWheelStateMachineStateGround},


                       {iTermScrollWheelStateMachineStateDrag, NSEventPhaseEnded, NSEventPhaseNone,
                        iTermScrollWheelStateMachineStateGround},
                       {iTermScrollWheelStateMachineStateDrag, NSEventPhaseChanged, NSEventPhaseNone,
                        iTermScrollWheelStateMachineStateDrag},
                       {iTermScrollWheelStateMachineStateDrag, NSEventPhaseNone, NSEventPhaseChanged,
                        iTermScrollWheelStateMachineStateGround},


                       {iTermScrollWheelStateMachineStateTouchAndHold, NSEventPhaseBegan, NSEventPhaseNone,
                        iTermScrollWheelStateMachineStateStartDrag},
                       {iTermScrollWheelStateMachineStateTouchAndHold, NSEventPhaseCancelled, NSEventPhaseNone,
                        iTermScrollWheelStateMachineStateGround}};
...
- (void)unexpectedEvent:(NSEvent *)event {
    DLog(@"Ignore unexpected event in state %@: %@", [self stateString:self.state], iTermShortEventPhasesString(event));
}
