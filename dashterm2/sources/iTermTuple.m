...
// Allowed classes for secure decoding - common property list types and secure coding conformers
+ (NSSet<Class> *)it_allowedClasses {
    static NSSet<Class> *allowedClasses;
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder {
    self = [super init];
    if (self) {
        // Use secure decoding with allowed classes
        _firstObject = [aDecoder decodeObjectOfClasses:[iTermTuple it_allowedClasses] forKey:@"firstObject"];
        _secondObject = [aDecoder decodeObjectOfClasses:[iTermTuple it_allowedClasses] forKey:@"secondObject"];
    }
    return self;
}
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder {
    ...
    if (self) {
        // Use secure decoding with allowed classes
        _thirdObject = [aDecoder decodeObjectOfClasses:[iTermTuple it_allowedClasses] forKey:@"thirdObject"];
    }
    return self;
}

- (void)encodeWithCoder:(NSCoder *)aCoder {
    // Must call super to encode firstObject and secondObject
