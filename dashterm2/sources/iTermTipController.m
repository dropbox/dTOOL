...
//
// BUG-6: Tip of the Day dialog strings updated to DashTerm2 branding
...
- (void)dealloc {
    // BUG-3123: Cancel delayed tryToShowTip selectors to prevent crash if
    // singleton is deallocated while a tip schedule is pending.
...
- (void)askForPermission {
    ...
    alert.informativeText = @"DashTerm2 can show you a Tip of the Day message to help you learn about its many features. Are you interested?";
