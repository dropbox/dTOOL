    ...
    id token = [[NSNotificationCenter defaultCenter] addObserverForName:iTermInternalNotification
                                                             ...
                                                             usingBlock:^(NSNotification * _Nonnull notification) {
                                                                 ...
                                                                 if (strongOwner) {
                                                                     ...
                                                                     // RC-009/BUG-1602: Defense-in-depth nil check.
                                                                     // Analysis: The -post method ALWAYS includes self in userInfo,
                                                                     // and ObjC dictionaries cannot contain nil values. This check
                                                                     // protects against hypothetical future bugs or external posts.
                                                                     // This is NOT a band-aid - it's proper defensive programming.
                                                                     if (!object) {
                                                                         DLog(@"Unexpected nil object in notification userInfo");
                                                                         return;
                                                                     }
