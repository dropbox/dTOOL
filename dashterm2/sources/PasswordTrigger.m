...
- (NSDictionary *)menuItemsForPoupupButton {
    [self addUnlockToAccountNamesIfNeeded];
    NSMutableDictionary *result = [[NSMutableDictionary alloc] initWithCapacity:_accountNames.count];
...
- (BOOL)performActionWithCapturedStrings:(NSArray<NSString *> *)stringArray
                    ...
                    atAbsoluteLineNumber:(long long)lineNumber
                        useInterpolation:(BOOL)useInterpolation
                                    stop:(BOOL *)stop {
    // Need to stop the world to get scope, provided it is needed. Password manager opens are so slow & rare that this
    // is ok.
