...
extension FunctionalKeyDefinition {
        ...
        private static func from(deviceIndependentFlag: NSEvent.ModifierFlags,
            ...
            func from(buckyBit: iTermBuckyBit,
                ...
                func from(nsEventFlag: NSEvent.ModifierFlags) -> CookedModifierFlags? {
                    ...
                    case .option: .option
                    case .function: nil
                    // BUG-2901: Don't crash on unknown flag - return nil
                    default: nil
                    }
                }
                ...
                case .`super`:
                    return .`super`
                // BUG-2901: Don't crash on unknown bucky bit - return nil
                @unknown default:
                    return nil
                }
            }
            ...
            // BUG-f538: Return empty result for unexpected device independent flags
            // instead of crashing. This handles edge cases like .option, .shift,
            // or future modifier flag additions gracefully.
            DLog("Unexpected device independent flag \(deviceIndependentFlag) - returning empty result")
            return result
        }
