...
@property(nonatomic, weak) id<iTermTextViewAccessibilityHelperDelegate> delegate;

// Call this when terminal content changes to invalidate the cached text.
// The cache will be lazily regenerated on the next accessibility query.
