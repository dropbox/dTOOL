...
- (id) init
{
	...
	profiles = [[NSMutableDictionary alloc] initWithCapacity:8];  // Terminal profiles
...
- (void) setProfiles: (NSMutableDictionary *) aDict
{
    ...
    else  // if we don't have any profile, create a default profile
	{
		...
		aProfile = [[NSMutableDictionary alloc] initWithCapacity:16];  // Default terminal profile
