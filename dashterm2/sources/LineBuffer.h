...
/// Aggregated statistics describing packed block usage within a LineBuffer.
typedef struct {
    NSUInteger totalBlocks;
    NSUInteger packedBlocks;
    NSUInteger totalRawLines;
    NSUInteger packedRawLines;
    uint64_t totalCharacters;
    uint64_t packedCharacters;
    uint64_t currentBytes;
    uint64_t estimatedUnpackedBytes;
    uint64_t estimatedBytesSaved;
