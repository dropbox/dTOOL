...
class ArchivesMenuBuilder: NSObject {
    // nonisolated(unsafe) because this is only accessed from main thread
    @objc nonisolated(unsafe) static var shared: ArchivesMenuBuilder?
    ...
    private func userSelectedArchivePath() async -> String? {
        ...
        // BUG-1788: Use if let with fallback instead of force unwrap
