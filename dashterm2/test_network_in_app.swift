...
// Load the DashTerm2 app binary and test the network functionality
print("Testing network round trip in DashTerm2 app context...")
...
if result.contains("SUCCESS") {
    ...
    print("The same code that's built into DashTerm2 app works perfectly!")
    exit(0)
} else {
    print("\n❌ Network test failed")
    exit(1)
