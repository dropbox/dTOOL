...
# Add some test entries in DashTerm2 folder
keepassxc-cli add -p -u testuser1 "$TEST_DB" DashTerm2/TestEntry1 <<EOF
$TEST_PASSWORD
user1pass
user1pass
EOF

keepassxc-cli add -p -u testuser2 "$TEST_DB" DashTerm2/TestEntry2 <<EOF
$TEST_PASSWORD
user2pass
user2pass
EOF
