...
open class SearchableComboView: NSPopUpButton {
    ...
    private var maxPanelHeightWhenBelow: CGFloat {
        ...
        return myFrameInScreenCoords.maxY - screen.visibleFrame.minY
    }
    ...
    private var maxPanelHeightWhenAbove: CGFloat {
        ...
        return max(minimumHeight, screen.visibleFrame.maxY - myFrameInScreenCoords.minY)
    }
    ...
    private func showPanel() {
        ...
        listViewController.view.frame = contentView.bounds
