...
final class BrowserExtensionTests: XCTestCase {
    ...
    func testContentScriptLoadingSuccess() async throws {
    ...
    func testContentScriptLoadingFileNotFound() async throws {
        let tempURL = FileManager.default.temporaryDirectory.appendingPathComponent(UUID().uuidString)
        try FileManager.default.createDirectory(at: tempURL, withIntermediateDirectories: true)
    ...
    func testContentScriptLoadingNoScripts() async throws {
        let manifest = ExtensionManifest(
            manifestVersion: 3,
            name: "Test Extension",
            version: "1.0"
    ...
    func testBackgroundScriptLoadingServiceWorker() async throws {
    ...
    func testBackgroundScriptLoadingLegacyScripts() async throws {
    ...
    func testBackgroundScriptLoadingNoBackground() async throws {
        let manifest = ExtensionManifest(
            manifestVersion: 3,
            name: "Test Extension",
            version: "1.0"
    ...
    func testBackgroundScriptLoadingFileNotFound() async throws {
        let tempURL = FileManager.default.temporaryDirectory.appendingPathComponent(UUID().uuidString)
        try FileManager.default.createDirectory(at: tempURL, withIntermediateDirectories: true)
