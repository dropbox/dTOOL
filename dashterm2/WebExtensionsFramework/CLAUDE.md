## Mission
We are building a Swift framework to enable a web browser I'm adding to DashTerm2 to use web extensions. There are some documents in the Documentation folder that describe more or less where this is going. The
