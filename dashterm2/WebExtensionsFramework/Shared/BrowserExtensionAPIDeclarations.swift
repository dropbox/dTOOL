...
func makeChromeStorage(inputs: APIInputs) -> APISequence {
    ...
    APISequence {
        ...
        // Note: The `impl` variable is scoped within the IIFE wrapper in chrome-storage-api.js template,
        // so it is NOT accessible from page context. The template wraps all generated code in:
        // (function() { 'use strict'; ... {{STORAGE_BODY}} ... })();
        // swiftlint:disable:next closure_body_length
