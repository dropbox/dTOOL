//! Streaming chat example with Perplexity AI
//!
//! Run with: cargo run --example perplexity_streaming_chat --package dashflow-perplexity
//!
//! Requires PPLX_API_KEY environment variable.
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Stream response
    println!("Streaming response from Perplexity AI:\n");
